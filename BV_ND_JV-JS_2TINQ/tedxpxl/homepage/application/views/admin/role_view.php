    ...
    <div class="span8">
        ...
        <tbody>
             <tr>
                <?php foreach ($roles as $role): ?>
                <td>
                    <a title="edit" href="<?php echo site_url('admin/role_edit').'/'.$role['id']; ?>"><img src="<?php echo base_url(); ?>assets/img/pencil.png"/></a> 
                    &nbsp;&nbsp;
                    <a title="delete" class="del" id="role_id_<?php echo $role['id']; ?>" href="<?php echo site_url('admin/role_delete').'/'.$role['id']; ?>"><img src="<?php echo base_url(); ?>assets/img/delete.png"/></a> 
                </td>
                <?php endforeach; ?>
            </tr>
			<tr>
                ...
                <td>
                    ...
                    <img src="<?php echo base_url(); ?>assets/img/accept.png"/>
                    <?php else: ?>
                    <img src="<?php echo base_url(); ?>assets/img/stop.png"/>
                    <?php endif; ?>
                </td>
                <?php endforeach; ?>
            </tr>
