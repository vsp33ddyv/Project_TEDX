...
<html lang="en">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/codeignitor/css/codeignitor.min.css"/>
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/codeignitor/css/codeignitor-responsive.min.css"/>
    <script src="<?php echo base_url(); ?>assets/codeignitor/js/jquery-1.7.2.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/codeignitor/js/codeignitor.min.js"></script>
    </head>
    <body>            
